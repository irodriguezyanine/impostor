...
export function GameCard({
  ...
  // Altura y posición fijas: civil e impostor idénticos para no delatar al impostor
  ...
  return (
    <div className="w-full max-w-md mx-auto perspective-1000">
      ...
      >
        {/* Frente: Pásale a X - absolute para posición fija */}
        <motion.div
        ...
        {/* Reverso: Rol revelado - absolute inset-0 = misma posición exacta que frente */}
        <motion.div
        ...
        >
          {/* Estructura fija: mismas zonas para civil e impostor = misma posición */}
          <div className="flex flex-col justify-between h-full text-center">
            {/* Zona 1: civil = texto+palabra; impostor = icono+texto */}
            <div className="min-h-[100px] flex flex-col justify-center">
              {role === "civilian" ? (
                ...
                <>
                  ...
                  <p className="text-slate-400 text-sm">{t.impostorDescription}</p>
                </>
              )}
            </div>
            {/* Zona 2: categoría - mismo espacio para ambos */}
            <div className="min-h-[52px] flex flex-col justify-center py-1">
              {role === "impostor" && showCategories && categoryNames.length > 0 ? (
            ...
            {/* Zona 3: pista - mismo espacio para ambos */}
            ...
            {/* Botón: siempre mismo lugar */}
            <motion.button
              whileTap={{ scale: 0.98 }}
              onClick={onHide}
              className="w-full py-4 px-6 rounded-2xl bg-primary text-gray-900 font-bold flex items-center justify-center gap-2 flex-shrink-0"
            >
              <EyeOff size={20} />
              {t.passToNextPlayer}
            </motion.button>
